...
// PluginUtils.h only forward-declares TritonOpBuilder (to keep pybind11 out of
// the non-python TritonTools buck lib); this TU calls the templated
// self.create<>() so it needs the complete type from ir.h.
