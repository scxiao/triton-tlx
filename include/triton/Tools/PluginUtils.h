...
// Defined in python/src/ir.h (pulls in pybind11). PluginUtils only references
// it by reference, so forward-declare to keep pybind11 out of TritonTools,
// which is a non-python lib in the beta buck build.
