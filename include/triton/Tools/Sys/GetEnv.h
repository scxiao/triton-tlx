...
inline const std::set<std::string> CACHE_INVALIDATING_ENV_VARS = {
    ...
    "TRITON_CPU_UNROLL_AND_REORDER_ELEMENTWISE_OPS",
    "TRITON_ALLOW_NPOT",
    ...
    "TRITON_DISABLE_2CTA_COOPERATIVE_LOADS",
    ...
    "TRITON_MODULO_PICK",
    "STANDALONE_MODULO",
    "STANDALONE_MODULO_MAX_STAGE_DIFF",
    "TRITON_CONTRACTED_COMPUTE_RATIO",
    "TRITON_MODULO_REG_DEFAULT",
    "TRITON_MODULO_CORES_PENALTY",
    "TRITON_MODULO_JOINT_SOLVER_TIMEOUT_S",
    "TRITON_MODULO_JOINT_SOLVER_RETRIES",
    "TRITON_MODULO_STRICT_ERROR",
    "TRITON_MODULO_JOINT_SOLVER_RLIMIT",
    "TRITON_MODULO_JOINT_SOLVER_SEED",
